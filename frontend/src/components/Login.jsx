...
const Login = () => {
    ...
    return (
        <div 
            ...
            <div className="w-full ">
                <p>Password</p>
                <input onChange={(e) => setPassword(e.target.value)} value={password} placeholder="type here" className="border border-gray-200 rounded w-full p-2 mt-1 outline-blue-200" type="password" required />
            </div>
            {state === "register" ? (
                <p>
