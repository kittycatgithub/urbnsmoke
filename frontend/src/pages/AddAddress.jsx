...
import { assets1 } from '../assets/assets1.js'
  ...
  return (
    <div className='mt-16 pb-16 max-w-5xl mx-auto px-4 lg:px-0 '>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping 
            <span className='font-semibold text-green-600'> Address</span></p>
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            ...
            <img className='md:mr-16 mb-16 md:mt-0' src={assets1.add_address_iamge} alt="Add Address" />
        </div>
    </div>
  )
}
